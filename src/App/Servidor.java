...
public class Servidor extends javax.swing.JFrame implements Runnable {
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        sendMessage(this.mensaje.getText());
    ...
    public void sendMessage(Object messageToSend) {
        try {
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                respuesta.setHorizontalAlignment(JLabel.LEADING);
                respuesta.setFont(new Font("Fira Code", Font.PLAIN, 18));
                respuesta.setOpaque(true);
                respuesta.setBackground(new Color(255, 188, 56));
                respuesta.setMaximumSize(new Dimension(Integer.MAX_VALUE, respuesta.getPreferredSize().height)); // Modificación aquí
